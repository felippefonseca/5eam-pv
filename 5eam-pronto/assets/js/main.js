(function(){
  ...
  if (!temGsap) {
    ...
    mm.add('(prefers-reduced-motion: no-preference)', function(){
      ...
      /* --- parallax do hero: foto sobe devagar, texto sai antes --- */
      gsap.to('.hero-bg img', {
  ...
  var faixas = [
    { t:'Marque as situações ao lado', m:'O medidor mostra o quanto a sua oficina ainda depende de você para funcionar.' },
